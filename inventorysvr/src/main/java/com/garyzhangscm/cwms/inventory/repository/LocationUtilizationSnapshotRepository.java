...
@Repository
public interface LocationUtilizationSnapshotRepository extends JpaRepository<LocationUtilizationSnapshot, Long>, JpaSpecificationExecutor<LocationUtilizationSnapshot> {
    ...
    @Transactional
    @Modifying
    @Query(value = "update location_utilization_snapshot set item_id = :newItemId  " +
