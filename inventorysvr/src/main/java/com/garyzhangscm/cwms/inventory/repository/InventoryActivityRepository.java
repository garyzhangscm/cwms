...
@Repository
public interface InventoryActivityRepository extends JpaRepository<InventoryActivity, Long>, JpaSpecificationExecutor<InventoryActivity> {
    List<InventoryActivity> findByLpn(String lpn);
    ...
    @Transactional
    @Modifying
    @Query(value = "update inventory_activity set item_id = :newItemId  " +
