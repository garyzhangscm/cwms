...
public class CycleCountRequestController {
    ...
    @RequestMapping(value = "/cycle-count-request/{batchId}", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/cycle-count-request/{batchId}/open", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/cycle-count-request/{batchId}/cancelled", method = RequestMethod.GET)
    ...
    public List<CycleCountResult> confirmCycleCountRequests(@RequestParam("cycle_count_request_ids") String cyclecountrequestIds){
    ...
    public List<CycleCountRequest> cancelCycleCountRequests(@RequestParam("cycle_count_request_ids") String cyclecountrequestIds){
    ...
    public List<CycleCountRequest> reopenCycleCountRequests(@RequestParam("cycle_count_request_ids") String cyclecountrequestIds){
