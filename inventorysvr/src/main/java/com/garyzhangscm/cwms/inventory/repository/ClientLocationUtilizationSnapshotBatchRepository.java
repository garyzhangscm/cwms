...
@Repository
public interface ClientLocationUtilizationSnapshotBatchRepository extends JpaRepository<ClientLocationUtilizationSnapshotBatch, Long>,
        JpaSpecificationExecutor<ClientLocationUtilizationSnapshotBatch> {
