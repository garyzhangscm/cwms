...
@Repository
public interface InventoryAdjustmentRequestRepository extends JpaRepository<InventoryAdjustmentRequest, Long>, JpaSpecificationExecutor<InventoryAdjustmentRequest> {
    ...
    @Transactional
    @Modifying
    @Query(value = "update inventory_adjustment_request set item_id = :newItemId  " +
