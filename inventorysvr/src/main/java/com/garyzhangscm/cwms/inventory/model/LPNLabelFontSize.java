...
@Entity
@Table(name = "lpn_label_font_size")
public class LPNLabelFontSize extends AuditibleEntity<String>{


    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "lpn_label_font_size_id")
    @JsonProperty(value="id")
    private Long id;

    @Column(name = "type")
    @Enumerated(EnumType.STRING)
    private LPNLabelFontType type;
    ...
    public LPNLabelFontSize(){}
    public LPNLabelFontSize(Long warehouseId,
                            LPNLabelFontType type,
    ...
    public LPNLabelFontType getType() {
        return type;
    }

    public void setType(LPNLabelFontType type) {
        this.type = type;
    }
