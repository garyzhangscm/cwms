...
public class TokenRefreshController {
    ...
    public LoginResponseWrapper refreshJWTToken(@RequestBody String refreshToken)  {


        return LoginResponseWrapper.of(0, "",
                userService.refreshJWTToken(
                    jwtService.getJWTTokenFromRequest(request), refreshToken)
        );
    }
