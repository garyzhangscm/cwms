...
@Repository
public interface ProductionLineMonitorRepository extends JpaRepository<ProductionLineMonitor, Long>, JpaSpecificationExecutor<ProductionLineMonitor> {

    ProductionLineMonitor findByWarehouseIdAndName(Long warehouseId, String name);
}
