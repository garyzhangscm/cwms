...
@Repository
public interface ProductionLineMonitorTransactionRepository extends JpaRepository<ProductionLineMonitorTransaction, Long>, JpaSpecificationExecutor<ProductionLineMonitorTransaction> {
