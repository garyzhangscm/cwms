...
@Repository
public interface WorkOrderKPITransactionRepository extends JpaRepository<WorkOrderKPITransaction, Long>, JpaSpecificationExecutor<WorkOrderKPITransaction> {
