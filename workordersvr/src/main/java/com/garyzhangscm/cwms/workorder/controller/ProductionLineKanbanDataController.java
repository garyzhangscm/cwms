...
import com.garyzhangscm.cwms.workorder.service.ProductionLineKanbanService;
...
@RestController
public class ProductionLineKanbanDataController {

    private static final Logger logger = LoggerFactory.getLogger(ProductionLineKanbanDataController.class);


    @Autowired
    ProductionLineKanbanService productionLineKanbanService;
    ...
    public List<ProductionLineKanbanData> getProductionLineKanbanData(
        ...
        return productionLineKanbanService.getProductionLineKanbanData(
                warehouseId, productionPlanId, productionLineIds, productionLineNames);
    }
