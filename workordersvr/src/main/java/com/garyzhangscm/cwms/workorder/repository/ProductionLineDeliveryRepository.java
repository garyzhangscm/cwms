...
import com.garyzhangscm.cwms.workorder.model.ProductionLineDelivery;
...
@Repository
public interface ProductionLineDeliveryRepository extends JpaRepository<ProductionLineDelivery, Long>,
        JpaSpecificationExecutor<ProductionLineDelivery> {

    ProductionLineDelivery findByProductionLineAndWorkOrderLine(
