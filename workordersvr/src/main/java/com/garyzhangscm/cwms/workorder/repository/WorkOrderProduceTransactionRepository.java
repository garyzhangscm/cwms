...
@Repository
public interface WorkOrderProduceTransactionRepository extends JpaRepository<WorkOrderProduceTransaction, Long>, JpaSpecificationExecutor<WorkOrderProduceTransaction> {
