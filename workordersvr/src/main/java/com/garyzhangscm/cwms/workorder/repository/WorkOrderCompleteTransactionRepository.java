...
@Repository
public interface WorkOrderCompleteTransactionRepository extends JpaRepository<WorkOrderCompleteTransaction, Long>, JpaSpecificationExecutor<WorkOrderCompleteTransaction> {
