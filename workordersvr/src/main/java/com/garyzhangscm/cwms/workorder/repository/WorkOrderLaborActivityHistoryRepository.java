...
@Repository
public interface WorkOrderLaborActivityHistoryRepository extends JpaRepository<WorkOrderLaborActivityHistory, Long>, JpaSpecificationExecutor<WorkOrderLaborActivityHistory> {
