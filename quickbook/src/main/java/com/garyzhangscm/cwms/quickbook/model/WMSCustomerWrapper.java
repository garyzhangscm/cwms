...
public class WMSCustomerWrapper implements Serializable {
    ...
    public WMSCustomerWrapper(){

    }
    public WMSCustomerWrapper(Customer customer) {
        setName(customer.getDisplayName());

        setDescription(customer.getDisplayName());
        setCompanyId(customer.getCompanyId());
        setWarehouseId(customer.getWarehouseId());
        setContactorFirstname(customer.getGivenName());
        setContactorLastname(customer.getFamilyName());
        Address address = Objects.nonNull(customer.getShipAddr()) ?
                customer.getShipAddr() : customer.getBillAddr();
