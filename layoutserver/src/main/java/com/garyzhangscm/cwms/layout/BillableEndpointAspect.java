...
import com.garyzhangscm.cwms.layout.clients.KafkaSender;
import com.garyzhangscm.cwms.layout.model.BillableRequest;
import com.garyzhangscm.cwms.layout.service.UserService;
...
public class BillableEndpointAspect {
    ...
    @Before(value = "@annotation(com.garyzhangscm.cwms.layout.model.BillableEndpoint)")
