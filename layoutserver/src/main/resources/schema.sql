...
INSERT INTO warehouse (name, size, address_country, address_state, address_county , address_city , address_street, address_line1, address_line2, address_postcode)
...
CREATE TABLE location(
  ...
  width double,
  height double,
  pick_sequence BIGINT not null,
  putaway_sequence BIGINT not null,
  count_sequence BIGINT not null,
  capacity double,
