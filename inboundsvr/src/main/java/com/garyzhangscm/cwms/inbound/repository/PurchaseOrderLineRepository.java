...
import com.garyzhangscm.cwms.inbound.model.PurchaseOrder;
import com.garyzhangscm.cwms.inbound.model.PurchaseOrderLine;
...
public interface PurchaseOrderLineRepository extends JpaRepository<PurchaseOrderLine, Long>, JpaSpecificationExecutor<PurchaseOrderLine> {
    ...
    @Transactional
    @Modifying
    @Query(value = "update purchase_order_line set item_id = :newItemId where item_id = :oldItemId  and warehouse_id = :warehouseId",
            nativeQuery = true)
