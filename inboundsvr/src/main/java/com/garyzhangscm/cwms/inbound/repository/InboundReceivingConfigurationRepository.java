...
@Repository
public interface InboundReceivingConfigurationRepository extends JpaRepository<InboundReceivingConfiguration, Long>, JpaSpecificationExecutor<InboundReceivingConfiguration> {
    ...
    @Transactional
    @Modifying
    @Query(value = "update inbound_qc_configuration set item_id = :newItemId where item_id = :oldItemId  and warehouse_id = :warehouseId",
            nativeQuery = true)
