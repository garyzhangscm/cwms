...
@Entity
@Table(name = "integration_bill_of_material_by_product")
public class DBBasedBillOfMaterialByProduct  extends AuditibleEntity<String> implements Serializable, IntegrationBillOfMaterialByProductData {


    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "integration_bill_of_material_by_product_id")
    ...
    public DBBasedBillOfMaterialByProduct(){}

    public BillOfMaterialByProduct convertToBillOfMaterialByProduct() {
        ...
        ObjectCopyUtil.copyValue(this, billOfMaterialByProduct, fieldNames);
