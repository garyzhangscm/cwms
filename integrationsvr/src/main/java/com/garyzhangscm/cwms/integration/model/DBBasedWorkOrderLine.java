...
public class DBBasedWorkOrderLine extends AuditibleEntity<String> implements Serializable, IntegrationWorkOrderLineData {
    ...
    public DBBasedWorkOrderLine(){}


    public DBBasedWorkOrderLine(WorkOrderLine workOrderLine) {

        setNumber(workOrderLine.getNumber());

        setWarehouseId(workOrderLine.getWarehouseId());
        setWarehouseName(workOrderLine.getWarehouseName());

        setItemId(workOrderLine.getItemId());
        setItemName(workOrderLine.getItemName());

        setExpectedQuantity(workOrderLine.getExpectedQuantity());

        setInventoryStatusId(workOrderLine.getInventoryStatusId());
        setInventoryStatusName(workOrderLine.getInventoryStatusName());

        setAllocationStrategyType(workOrderLine.getAllocationStrategyType());
    ...
    public WorkOrderLine convertToWorkOrderLine() {
        ...
        ObjectCopyUtil.copyValue(this, workOrderLine, fieldNames);
