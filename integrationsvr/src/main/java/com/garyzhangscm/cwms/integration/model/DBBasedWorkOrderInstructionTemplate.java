...
public class DBBasedWorkOrderInstructionTemplate extends AuditibleEntity<String> implements Serializable, IntegrationWorkOrderInstructionTemplateData {
    ...
    @Column(name = "integration_work_order_instruction_template_id")
    ...
    public DBBasedWorkOrderInstructionTemplate(){}

    public WorkOrderInstructionTemplate convertToWorkOrderInstructionTemplate() {
        ...
        ObjectCopyUtil.copyValue(this, workOrderInstructionTemplate, fieldNames);
