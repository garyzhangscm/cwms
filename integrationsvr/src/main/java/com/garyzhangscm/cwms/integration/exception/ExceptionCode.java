package com.garyzhangscm.cwms.integration.exception;
...
public enum ExceptionCode {
    RESOURCE_NOT_FOUND(30000, HttpStatus.NOT_FOUND, "Can't Find the Resource"),
    REQUEST_VALIDATION_FAILED(30001, HttpStatus.BAD_REQUEST, "Validation Fail"),
    MISSING_INFORMATION(30002, HttpStatus.BAD_REQUEST, "Can't proceed due to missing information");
