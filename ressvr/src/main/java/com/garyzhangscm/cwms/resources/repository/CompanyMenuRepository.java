...
@Repository
public interface CompanyMenuRepository extends JpaRepository<CompanyMenu, Long>, JpaSpecificationExecutor<CompanyMenu> {

    List<CompanyMenu> findByCompanyId(Long companyId);
