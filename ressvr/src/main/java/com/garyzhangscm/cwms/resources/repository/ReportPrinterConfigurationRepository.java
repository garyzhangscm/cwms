...
@Repository
public interface ReportPrinterConfigurationRepository extends JpaRepository<ReportPrinterConfiguration, Long>, JpaSpecificationExecutor<ReportPrinterConfiguration> {

    ReportPrinterConfiguration findByWarehouseIdAndReportTypeAndCriteriaValue(
