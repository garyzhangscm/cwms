...
/**
 * This class will control what report we will print at certain point
 * TO-DO
 */
@Entity
@Table(name = "printing_report_check_point_filter_header")
public class PrintingReportCheckPointFilterHeader extends AuditibleEntity<String>    {

    private static final long serialVersionUID = 1L;

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "printing_report_check_point_filter_header_id")
    private Long id;
