...
import com.garyzhangscm.cwms.resources.clients.KafkaSender;
import com.garyzhangscm.cwms.resources.model.BillableRequest;
...
public class BillableEndpointAspect {
    ...
    @Before(value = "@annotation(com.garyzhangscm.cwms.resources.model.BillableEndpoint)")
