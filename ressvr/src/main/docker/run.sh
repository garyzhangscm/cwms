...
java -Dspring.cloud.config.uri=$CONFIGSERVER_URI -Dspring.profiles.active=$SPRING_PROFILE -Dspring.database.url=$DATABASE_URL -jar /usr/local/ressvr/@project.build.finalName@.jar