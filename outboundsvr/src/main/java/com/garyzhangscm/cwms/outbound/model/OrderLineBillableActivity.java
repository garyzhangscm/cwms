...
@Entity
@Table(name = "outbound_order_line_billable_activity")
public class OrderLineBillableActivity extends AuditibleEntity<String>{

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "outbound_order_line_billable_activity_id")
