...
@Entity
@Table(name = "outbound_order_billable_activity")
public class OrderBillableActivity extends AuditibleEntity<String>{

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "outbound_order_billable_activity_id")
