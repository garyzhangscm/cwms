...
public class Order implements Serializable {
    ...
    /*
    *  We can specify where the order will be staged
    *  */
    ...
    public Order(Warehouse warehouse, String number,
                 Customer shipToCustomer, Customer billToCustomer) {

        this.number = number;


        this.shipToCustomerId = shipToCustomer.getId();
        this.shipToCustomerName = shipToCustomer.getName();
        this.shipToCustomer = shipToCustomer;

        this.billToCustomerId = billToCustomer.getId();
        this.billToCustomerName = billToCustomer.getName();
