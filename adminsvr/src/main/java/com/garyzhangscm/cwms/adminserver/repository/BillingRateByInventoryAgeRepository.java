...
@Repository
public interface BillingRateByInventoryAgeRepository extends JpaRepository<BillingRateByInventoryAge, Long>, JpaSpecificationExecutor<BillingRateByInventoryAge> {
}
