 ...
 */
@Service
public class StorageFeeByPalletCountBillingService extends  StorageFeeBillingService {
    private static final Logger logger = LoggerFactory.getLogger(StorageFeeByPalletCountBillingService.class);
    @Autowired
    ...
    public BillableCategory getBillableCategory() {
        return BillableCategory.STORAGE_FEE_BY_PALLET_COUNT;
    }
}
